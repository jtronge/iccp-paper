...
steps:
  makeblastdb:
    ...
    run:
      ...
      hints:
        ...
        Pull: {files: carAur01.sm.fa}
        Push: {files: databases}
      inputs:
  ...
  task-NC_009057-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009057.fasta}
        Push: {files: task-NC_009057-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009058-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009058.fasta}
        Push: {files: task-NC_009058-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009059-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009059.fasta}
        Push: {files: task-NC_009059-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009060-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009060.fasta}
        Push: {files: task-NC_009060-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009062-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009062.fasta}
        Push: {files: task-NC_009062-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009063-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009063.fasta}
        Push: {files: task-NC_009063-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009064-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009064.fasta}
        Push: {files: task-NC_009064-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009065-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009065.fasta}
        Push: {files: task-NC_009065-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009066-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009066.fasta}
        Push: {files: task-NC_009066-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009067-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009067.fasta}
        Push: {files: task-NC_009067-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_009459-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_009459.fasta}
        Push: {files: task-NC_009459-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_010205-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_010205.fasta}
        Push: {files: task-NC_010205-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011168-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011168.fasta}
        Push: {files: task-NC_011168-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011169-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011169.fasta}
        Push: {files: task-NC_011169-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011170-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011170.fasta}
        Push: {files: task-NC_011170-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011171-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011171.fasta}
        Push: {files: task-NC_011171-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011177-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011177.fasta}
        Push: {files: task-NC_011177-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_011179-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_011179.fasta}
        Push: {files: task-NC_011179-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_012055-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_012055.fasta}
        Push: {files: task-NC_012055-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_013564-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_013564.fasta}
        Push: {files: task-NC_013564-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_013577-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_013577.fasta}
        Push: {files: task-NC_013577-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_013663-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_013663.fasta}
        Push: {files: task-NC_013663-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_013750-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_013750.fasta}
        Push: {files: task-NC_013750-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_018814-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_018814.fasta}
        Push: {files: task-NC_018814-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
  task-NC_018815-fasta:
    ...
    run:
      ...
      hints:
        DockerRequirement: {dockerImageId: blast.tar.gz}
        Pull: {files: databases|NC_018815.fasta}
        Push: {files: task-NC_018815-fasta.reference}
      inputs:
        db_dir: {type: string}
      outputs:
        out: {type: string}
